            ...
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE;">
                  <img alt="logo" src="https://mailsend-email-assets.mailtrap.io/43gwhggsm77ca5g06e5uucwpt0qf.png" id="navbar-logo" style="width:100;">
                </td>
              </tr>
              <tr>
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        Welcome to MyInnoVet System!
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                        We're thrilled to have you on board and introduce you to the ultimate solution for hassle-free appointment booking and convenient access to pet medical records. With MyInnoVet, managing your veterinary clinic has never been easier.
                        </td>
                      </tr>

                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                         Join us now and unlock the future of veterinary clinic management with MyInnoVet.
                        </td>
                      </tr>

                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <a class="button" href="{{next_step_link}}" title="Reset Password" style="width: 100%; background: #39A6EC; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Get Started</a>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>MyInnoVet</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
