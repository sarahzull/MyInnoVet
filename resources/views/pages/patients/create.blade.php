...
<div class="card">
  ...
  <div class="card-body">
    <form
            ...
            <div class="row">
              <div class="col-lg-12 fv-row">
                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('assets/media/svg/avatars/blank.svg') }}')">
                  <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('assets/media/avatars/blank.png') }}')">
                  </div>
            ...
            <div class="row">
              <div class="col-lg-12 fv-row">
                <div class="position-relative d-flex align-items-center">
                  ...
                  <input type="date" name="dob" id="dob" class="form-control form-control-solid ps-12" placeholder="Select a date" name="dob" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="mb-6">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 fv-row">
                <input type="text" name="breed" id="breed" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mb-6">
        <div class="row">
          <label class="col-lg-4 col-form-label required fw-semibold fs-6">Species</label>
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 fv-row">
      ...
      <div class="mb-6">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 fv-row">
                <input type="number" name="height" id="height" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mb-6">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 fv-row">
                <input type="number" name="weight" id="weight" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mb-6">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12 fv-row">
                <input type="text" name="chronic_disease" id="chronic_disease" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"/>
              </div>
            </div>
          </div>
        </div>
